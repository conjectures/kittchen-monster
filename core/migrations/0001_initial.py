    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', models.TextField(blank=True, help_text='Recipe body', max_length=1000, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('images', models.ImageField(blank=True, null=True, upload_to='images/')),
                ('recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images2', to='core.post')),
            ],
        ),
        migrations.CreateModel(
            name='Direction',
